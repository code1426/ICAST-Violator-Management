  ...
  return (
    <div className="relative inline-block text-left lg:text-base md:text-sm text-xs">
      <button
        ...
        className="bg-color1 hover:bg-color2 border-gray-300 transition-all rounded-lg py-2 px-4 shadow-md shadow-gray-500 flex items-center text-white w-22 h-11">
