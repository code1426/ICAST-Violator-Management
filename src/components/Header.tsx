...
const Header = () => {
  ...
  return (
    <header className="flex items-center h-14 bg-color1 py-2 px-1 z-30 shadow-md shadow-gray-500 fixed top-7 left-0 right-0">
      <Link to="/home" className="flex flex-row items-center">
        <img src="./Logo.png" alt="Logo" className="mx-3 w-7 h-7" />
        <h1 className="lg:text-xl md:text-base text-xs font-bold text-center text-color6">
