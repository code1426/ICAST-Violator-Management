  ...
  return (
    <div className="flex rounded-full md:py-2 md:px-2.2 py-2 px-3 w-5/6 bg-color3 space-x-2 border-b-color2 shadow-md shadow-gray-500">
      <input
        ...
        value={searchValue}
        placeholder="Search..."
        className="border-2 border-black rounded-full hover:ring-2 bg-color6 hover:ring-gray-600 transition-all px-5 py-1.5 w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-600 lg:text-base md:text-sm text-xs "
